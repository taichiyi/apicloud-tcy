/* Zepto v1.2.0 - simplify MIT
     modifier: taichiyi
 */
console.log('load_zepto-taichiyi-live');
(function(global, factory) {
    if (typeof define === 'function' && define.amd) {
        define(function() {
            console.log('run_zepto-taichiyi-live');
    ...
    var Zepto = (function() {
        ...
        $.fn = {
            ...
            removeClass: function(name) {
                ...
                if (this.length === 0) return this;
                if (!('className' in this[0])) return this;
                classListStr = this[0].classList.value;
                if (classListStr === '') return this;
