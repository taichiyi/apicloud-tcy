    ...
    (function(window) {
        ...
        function openWin(params) {
            ...
            if (type(params.pageParam) === 'object') {
                ...
                params.pageParam.fromWin = api.winName;
                params.pageParam.fromFrm = api.frameName;
            } else { //没传pageParam参数
                params.pageParam = {};
                params.pageParam.fromWin = api.winName;
                params.pageParam.fromFrm = api.frameName;
            ...
            console.log('api.openWin(default_json);');
        ...
        function openFrame(params) {
            ...
            console.log('api.openFrame(default_json);');
            console.log(JSON.stringify(default_json));
        ...
        function ajax_core(params, callback) {
            ...
            console.log('api.ajax(default_params)');
